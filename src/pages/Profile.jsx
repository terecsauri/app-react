            ...
            <CardHeader>
                <Heading size='md'>Este es mi perfil, ¡viva!</Heading>
                    ...
                    <CardBody display={"flex"} flexDir={"column"} alignItems={'center'} justifyContent={"center"}>
                        ...
                        <Text display={"flex"} alignItems={'center'} justifyContent={"center"}><br/>¡Soy {user.name.first}!</Text>

                        <Divider />

                        <Text display={"flex"} alignItems={'center'} justifyContent={"center"}>¡Mi apellido es {user.name.last}!</Text>

                        <Divider />

                        <Text display={"flex"} alignItems={'center'} justifyContent={"center"}>¡Vivo en {user.location.city}, que está en {user.location.country}!</Text>
                    </CardBody>
